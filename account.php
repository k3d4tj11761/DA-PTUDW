...
<!-- Dang Nhap -->
 ...
 <!-- Dang Ky -->
    ...
    <label class="username">
     ...
     <label class="username">
	 <input id="username" type="text" autocomplete="on" name="SDT" placeholder="Số Điện Thoại" value=""	 />
 	</label>
    
    <label class="username">
	 <input id="username" type="text" autocomplete="on" name="Email" placeholder="Email" value=""	 />
 	</label>
    
    <label class="username">
	 <input id="username" type="text" autocomplete="on" name="Dia_Chi" placeholder="Địa Chỉ" value=""	 />
 	</label>
